...
| Метрика | ResNet18 | ResNet34 | ResNet50 | EfficientNet B7 | VGG16 |
|---------|---------|---------|----------|-----------------|-------|
| Precision | 0.8821 | **0.9235** | 0.8740 | 0.7645 | 0.7726 |
| Recall | 0.9036 | **0.9602** | 0.8804 | 0.2810 | 0.3102 |
| F1 Score | 0.8803 | **0.9332** | 0.8649 | 0.4077 | 0.4596 |
| Средняя ошибка (пиксели) | **25.61** | 25.65 | 37.69 | 44.80 | 42.70 |
| Точность локализации | **0.5570** | 0.5505 | 0.2541 | 0.1197 | 0.1363 |
